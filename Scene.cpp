...
void CScene::AnimateObjects(float fTimeElapsed)
{
	...
	if (NightMode)
	{
		...
		m_pLights->m_pLights[5].m_fRange = 8.0f;
		...
		m_pLights->m_pLights[5].m_xmf3Position = XMFLOAT3(72.0f, 1.0f, 55.0f);
		m_pLights->m_pLights[5].m_xmf3Direction = XMFLOAT3(72.0f, 0.0f, 55.0f);
		m_pLights->m_pLights[5].m_xmf3Attenuation = XMFLOAT3(1.0f, 0.01f, 0.001f);
		m_pLights->m_pLights[5].m_fFalloff = 1.0f;
		m_pLights->m_pLights[6].m_bEnable = true;
		m_pLights->m_pLights[6].m_nType = SPOT_LIGHT;
		m_pLights->m_pLights[6].m_fRange = 8.0f;
		m_pLights->m_pLights[6].m_xmf4Ambient = XMFLOAT4(0.01f, 0.01f, 0.01f, 1.0f);
		m_pLights->m_pLights[6].m_xmf4Diffuse = XMFLOAT4(0.01f, 0.01f, 0.01f, 1.0f);
		m_pLights->m_pLights[6].m_xmf4Specular = XMFLOAT4(0.01f, 0.01f, 0.01f, 1.0f);
		m_pLights->m_pLights[6].m_xmf3Position = XMFLOAT3(18.0f, 1.0f, -0.5f);
		m_pLights->m_pLights[6].m_xmf3Direction = XMFLOAT3(18.0f, 0.0f, -0.5f);
		m_pLights->m_pLights[6].m_xmf3Attenuation = XMFLOAT3(1.0f, 0.01f, 0.001f);
		m_pLights->m_pLights[6].m_fFalloff = 1.0f;
		m_pLights->m_pLights[7].m_bEnable = true;
		m_pLights->m_pLights[7].m_nType = SPOT_LIGHT;
		m_pLights->m_pLights[7].m_fRange = 8.0f;
		...
		m_pLights->m_pLights[7].m_xmf3Position = XMFLOAT3(72.0f, 1.0f, -55.0f);
